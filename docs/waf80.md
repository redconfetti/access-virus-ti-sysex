...
| B#      | Name                                            | Range / values                                                                                                                                                                                                                                      |
| ------- | ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1       | Arp Mode                                        | 0–6 Off, Up, Down, Up&Down, AsPlayed, Random, Chord — TI mk2: `71`/`0F` — [Arpeggiator Mode](live-edit/arpeggiator.md#arpeggiator-mode-cmd0x71-param-0x0f) (+ **`07`** Arp>Matrix) |
| 3       | Arp Octave Range                                | 0–3 — TI mk2: `71`/`03` — [Arpeggiator Octaves](live-edit/arpeggiator.md#arpeggiator-octaves-cmd0x71-param-0x03) (LCD **1**–**4**) |
| 4       | Arp Hold Enable                                 | 0/1 — TI mk2: `71`/`04` — [Arpeggiator Hold](live-edit/arpeggiator.md#arpeggiator-hold-cmd0x71-param-0x04) |
| 7       | Lfo3 Rate                                       | 0–127                                                                                                                                                                                                                                               |
| 8       | Lfo3 Shape                                      | 0–5                                                                                                                                                                                                                                                 |
...
| 17      | Arp Clock                                       | 1–17 — TI mk2: `71`/`11` — [Arpeggiator Resolution](live-edit/arpeggiator.md#arpeggiator-resolution-cmd0x71-param-0x11) (**1/128**–**1/2**, no **Off**) |
...
| 39      | Vocoder Mode                                    | TI: `71` / `0x27` — [Vocoder Mode](live-edit/effects.md#vocoder-mode-cmd0x71-param-0x27) (`00`–`06` on TI mk2)                                                                                                                                       |
