...
| 3       | p       | Contr 3                 |                                                                                                                                                                   |
| 4       | p       | Foot Controller         |                                                                                                                                                                   |
| 5       | a       | Portamento Time         | TI: `70` / `0x05` — [Portamento](single-live-edit.md#portamento-0x05-cmd0x70--cc-5) (Off `00`, **1..127** direct)                                                                                                                  |
| 6       | p       | Data Slider             |                                                                                                                                                                   |
...
| 30      | a       | FM Filt Env Amt         | TI: `70` / `0x1E` — **FilterEnv>FM** (Sync Off) / **FilterEnv>Sync** (Sync On); **−100..+100 %** — [Osc 2 Classic](single-live-edit.md#oscillator-2--classic) |
...
| 34      | a       | Suboscillator Volume    | TI: `70` / `0x22` — [Sub Oscillator Volume](single-live-edit.md#sub-oscillator-volume-0x22-cmd0x70--cc-34) (**0..127** direct)                                      |
| 35      | a       | Suboscillator Shape     | TI: `70` / `0x23` — [Sub Oscillator Shape](single-live-edit.md#sub-oscillator-shape-0x23-cmd0x70--cc-35) (Square `00`, Triangle `01`)                             |
...
| 37      | a       | Noise Volume            | TI: `70` / `0x25` — [Noise Volume](single-live-edit.md#noise-volume-0x25-cmd0x70--cc-37) (Off `00`, **1..127** direct)                                             |
| 38      | a       | Ringmodulator Volume    | TI: `70` / `0x26` — [Ring Modulator Volume](single-live-edit.md#ring-modulator-volume-0x26-cmd0x70--cc-38) (Off `00`, **1..127** direct)                          |
| 39      | a       | Noise Color             | TI: `70` / `0x27` — [Noise Color](single-live-edit.md#noise-color-0x27-cmd0x70) (**−64..+63**, `stored = ui + 64`)                                                |
...
| 101     | a       | Input Mode              | 0 Off / 1 Dynamic / 2 Static — TI live: also **`6F`/`7C`** — [Inputs](single-live-edit.md#inputs-edit-single)                                                       |
...
| 35      | Osc Init Phase                                  |                                                                                                                                                                                                                                         |
| 36      | Punch Intensity                                 | TI: `71` / `0x24` — [Punch](single-live-edit.md#punch-intensity-0x24-cmd0x71) (`pct = stored × 100 / 128`, `7F` → 100 %)                                                                                                              |
| 39      | Vocoder Mode                                    | 0–12                                                                                                                                                                                                                                    |
| 47–57   | Velocity amounts                                | TI Velocity Map: [single-live-edit.md](single-live-edit.md#velocity-map-edit-single) (`71`/`2F`–`39`, `3C`–`3D`; ±100 % like FilterEnv>Pitch)                                                                                         |
| 60–61   | Amp / Pan velocity                              | TI: Volume **`3C`**, Panorama **`3D`** — same section                                                                                                                                                                                   |
| 62–63   | Definable1/2 Single                             | TI Soft Knob 1–3 **Function As…**: `71`/`3E`, `3F`, `40` — [Soft Knobs](single-live-edit.md#soft-knobs-edit-single) |
