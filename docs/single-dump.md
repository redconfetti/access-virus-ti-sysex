...
Live-edit notes (`cmd=0x6E`, `cmd=0x70`, `cmd=0x71`, etc.) are in
...
See also [waf80.md — Arrangement Request](waf80.md#arrangement-request-0x34)
and [testing.md — Capture `DUMP_MULTI`](testing.md#4-capture-dump_multi).
...
sequenceDiagram
    ...
    Host->>Virus: REQUEST_ARRANGEMENT cmd 0x34 00
    Virus-->>Host: DUMP_MULTI cmd 0x11, 267 bytes
    loop Parts 1 through 16
...
| Arpeggiator Range In Octaves         | Settings       |             |           |
