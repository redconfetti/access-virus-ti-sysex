...
| Distortion Mix                  | Distortion                    |             | `6E` / `0x48` — [Mix](effects.md#distortion-mix-cmd0x6e-param-0x48; [panel visibility](../parameter-options.md#distortion-panel-visibility)      |
...
| EQ Mid Gain (db)                | Equalizer                     |             | `71` / `0x5C` — [Gain](effects.md#eq-mid-gain-cmd0x71-param-0x5c; same as [Low Gain](../parameter-options.md#eq-low-gain)                        |
...
| EQ High Gain (db)               | Equalizer                     |             | `71` / `0x60` — [Gain](effects.md#eq-high-gain-cmd0x71-param-0x60; same as [Low Gain](../parameter-options.md#eq-low-gain)                       |
...
| Delay Send                              | Delay              |             | `70` / `0x71` — [Delay Send](effects.md#delay-send-cmd0x70-param-0x71 + [LCD](../parameter-options.md#delay-send-lcd)                              |
| Delay Type                              | Delay              |             | `6E` / `0x0A` — [Delay Type](effects.md#delay-type-cmd0x6e                                                                                         |
| Delay Mode                              | Delay              |             | `70` / `0x70` — [Mode](../parameter-options.md#delay-mode); **`01`–`16`**                                                                          |
| Delay Clock                             | Delay              |             | [Delay Clock](../parameter-options.md#delay-clock) — Simple/Ping Pong modes                                                                        |
| Delay Time (ms)                         | Delay              |             | `70` / `0x72` — Classic Simple/Ping Pong + [Clock](../parameter-options.md#delay-clock) **Off** only; **not** on Pattern modes; tape **Time**      |
| Delay Feedback                          | Delay              |             | `70` / `0x73` — [Feedback](effects.md#delay-feedback; Classic **0..100 %** (TX on **Pattern 5+5**), Tape **0..200 %**                              |
| Delay Coloration                        | Delay              |             | `70` / `0x77` — [Coloration](../parameter-options.md#delay-coloration); TX on **Pattern 5+5**; mod-matrix id **`0x54`**                            |
...
| Delay Tape Delay Clock Left             | Delay Tape Clocked |             | `6E` / `0x0D` — [Left Clock](../parameter-options.md#delay-tape-left-clock)                                                                        |
| Delay Tape Delay Clock Right            | Delay Tape Clocked |             | `6E` / `0x0E` — [Right Clock](../parameter-options.md#delay-tape-right-clock)                                                                      |
...
| Delay Tape Delay Ratio                  | Delay Tape Free    |             | `6E` / `0x0C` — [Ratio](../parameter-options.md#delay-tape-ratio)                                                                                  |
| Delay Tape Delay Time (ms)              | Delay Tape Free    |             | `70` / `0x72` — panel **Time** = [Delay Time (ms)](../parameter-options.md#delay-tape-time)                                                        |
...
| Delay Tape Delay Ratio                  | Delay Tape Doppler |             | `6E` / `0x0C` — same as [Tape Free](../parameter-options.md#delay-tape-ratio)                                                                      |
| Delay Tape Delay Time (ms)              | Delay Tape Doppler |             | `70` / `0x72` — panel **Time** = [Delay Time (ms)](../parameter-options.md#delay-tape-time)                                                        |
| Delay Tape Delay Feedback               | Delay Tape Doppler |             | `70` / `0x73` — **0..200 %**; same as Tape Clocked / Free                                                                                          |
| Delay Tape Delay Center Frequency       | Delay Tape Doppler |             | `70` / `0x77` — **`0`–`127`** — [Frequency](../parameter-options.md#delay-tape-frequency)                                                          |
| Delay Tape Delay Bandwidth              | Delay Tape Doppler |             | `6E` / `0x11` — **`0`–`127`** — [Bandwidth](../parameter-options.md#delay-tape-bandwidth)                                                          |
| Delay Tape Delay Modulation             | Delay Tape Doppler |             | `70` / `0x75` — **0..100 %** — [Modulation](../parameter-options.md#delay-tape-modulation)                                                         |
| FX Reverb Switch                        | Reverb             |             |                                                                                                                                                    |
| Reverb Send                             | Reverb             |             | `6E` / `0x02` — [Reverb Send (LCD)](../parameter-options.md#reverb-send-lcd)                                                                       |
