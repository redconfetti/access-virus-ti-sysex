...
Oscillator **Wavetable** wave select names (`cmd=0x70`, `param=0x13`, **Mode `02`**).
**Wire** = index **`00`–`63`** for panel indices **0–99**. Order confirmed on TI mk2
hardware (full **+** sweep).
...
**Mode `01`**, `cmd=0x70`, `param=0x11`. **Wire:** `internal = 1 + stored × 8 / 127`.
