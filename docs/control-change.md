...
[global-live-edit.md](live-edit/edit-config.md#midi-controller-page-a-0x5e).
...
[Sub Oscillator
Volume](docs/live-edit/oscillators.md#sub-oscillator-volume-0x22-cmd0x70--cc-34).
...
Triangle **`01`** only — [Sub Oscillator
Shape](docs/live-edit/oscillators.md#sub-oscillator-shape-0x23-cmd0x70--cc-35).

### Patch Transpose (CC 93)

**Edit Single → Common → Transpose** (Patch Transpose). With **Page A = SysEx**,
**`cmd=0x70` `param=0x5D`** (**−64..+63** → `ui+64`) — see
[Transpose](docs/live-edit/edit-single.md#transpose--patch-transpose-0x5d-cmd0x70--cc-93).
...
**`param=0x0A`** — see
[Panorama](docs/live-edit/edit-single.md#panorama-0x0a-cmd0x70--cc-10).
...
| **SysEx** | Page A = **SysEx**           | `F0 … 70 <part> 5E <value> F7` — [single-live-edit.md](docs/live-edit/edit-single.md#key-mode-0x5e-cmd0x70--cc-94) |
