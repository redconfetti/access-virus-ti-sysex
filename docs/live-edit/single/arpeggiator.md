...
```text
F0 00 20 33 01 00 71 40 0F 00 F7 # Off (arp disabled)
F0 00 20 33 01 00 71 40 0F 01 F7 # Up (panel ARP on)
F0 00 20 33 01 00 71 40 0F 02 F7 # Down
F0 00 20 33 01 00 71 40 0F 03 F7 # Up&Down
F0 00 20 33 01 00 71 40 0F 04 F7 # As Played
F0 00 20 33 01 00 71 40 0F 05 F7 # Random
F0 00 20 33 01 00 71 40 0F 06 F7 # Chord
F0 00 20 33 01 00 71 40 0F 07 F7 # Arp>Matrix
```
...
```text
F0 00 20 33 01 00 71 40 02 00 F7 # User
F0 00 20 33 01 00 71 40 02 01 F7 # 2
F0 00 20 33 01 00 71 40 02 3F F7 # 64
```
...
```text
F0 00 20 33 01 00 71 40 03 00 F7 # 1 octave
F0 00 20 33 01 00 71 40 03 03 F7 # 4 octaves
```
...
```text
F0 00 20 33 01 00 71 40 11 01 F7 # 1/128
F0 00 20 33 01 00 71 40 11 11 F7 # 1/2
```
...
```text
F0 00 20 33 01 00 71 40 05 00 F7 # −100.0 %
F0 00 20 33 01 00 71 40 05 40 F7 # +0.0 %
F0 00 20 33 01 00 71 40 05 7F F7 # +100.0 %
```
...
```text
F0 00 20 33 01 00 71 40 06 00 F7 # Off
F0 00 20 33 01 00 71 40 06 01 F7 # 50.2 %
F0 00 20 33 01 00 71 40 06 15 F7 # 16B
F0 00 20 33 01 00 71 40 06 42 F7 # 16D
F0 00 20 33 01 00 71 40 06 7F F7 # 75.0 %
```
...
```text
F0 00 20 33 01 00 71 40 04 00 F7 # Off
...
```text
F0 00 20 33 01 00 6E 40 7F 00 F7 # 1 step
F0 00 20 33 01 00 6E 40 7F 01 F7 # 2 steps
F0 00 20 33 01 00 6E 40 7F 0F F7 # 16 steps
F0 00 20 33 01 00 6E 40 7F 1F F7 # 32 steps
```
...
```text
F0 00 20 33 01 00 6F 40 5D 00 F7 # Step 32 length −100.0 %
F0 00 20 33 01 00 6F 40 5D 40 F7 # Step 32 length +0.0 %
F0 00 20 33 01 00 6F 40 5D 7F F7 # Step 32 length +100.0 %
```
...
```text
F0 00 20 33 01 00 6F 40 01 00 F7 # Step 1 velocity 0
F0 00 20 33 01 00 6F 40 01 7F F7 # Step 1 velocity 127
F0 00 20 33 01 00 6F 40 5E 7F F7 # Step 32 velocity 127
```
...
```text
F0 00 20 33 01 00 6F 40 02 00 F7 # Step 1 off
F0 00 20 33 01 00 6F 40 02 01 F7 # Step 1 on
F0 00 20 33 01 00 6F 40 5F 01 F7 # Step 32 on
```
